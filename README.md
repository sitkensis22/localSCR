...
from either raster data or spatial polygons, 4) provide template SECR
models that are easily customizable, 5) fit and summarize SECR models
...
## Vignettes
  ...
  - [Classic SCR models: continuous state-space and marked
    individuals](https://github.com/sitkensis22/localSCR/vignettes/tutorial-1.01.Rmd)
