...
description: >
  Learn how to simulate and analysis basic SCR data 
...
# bind simulated activity centers with vector of the number of individuals detections
...
```{r, fig.show='hide', fig.height=14, fig.width=10}
