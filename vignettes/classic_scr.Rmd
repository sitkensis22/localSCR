...
vignette: >
  %\VignetteIndexEntry{classic_scr}
...
Finally, in some SCR designs, trap arrays may be spread out over the study area such that individuals can only be detected at one of multiple trap arrays (e.g., Furnas et al. 2018). This necessitates including the traps as a 3-dimensional array and using a site identifier to track which site a detected or augmented individual belongs to. 
